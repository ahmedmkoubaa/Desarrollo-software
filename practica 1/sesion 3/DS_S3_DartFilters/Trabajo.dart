...
class Trabajo{
  ...
  void darParteTrabajo(int horas, int costoMateriales, int costoDesplazamiento){
  if (parteTrabajo != null) {
    ...
    parteTrabajo = new ParteTrabajo(horas, costoMateriales, costoDesplazamiento);
  }
}
  ...
  Tecnico getTecnico(){return tecnico;}

  ParteTecnico getParteTecnico(){return parteTecnico;}

  ParteTrabajo getParteTrabajo(){return parteTrabajo;}
